...
import com.bugotruco.mishimentor.search.MishiSeeker;
    ...
    public String realizarAuditoriaPro(String rutaArchivo) {
        ...
        do {
            ...
            try {
                ...
                String dudaTecnica = promptLoader.getDudaTecnica() + " " + extraerLibrerias(codigo);
                ...
                String promptAumentado = promptLoader.getSystemPromptAnalista()
                        .replace("${CONTEXTO_WEB}", contextoWebUnificado)
